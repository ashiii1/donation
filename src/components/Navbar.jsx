...
{/* <div className="fixed bottom-0 left-0 w-full bg-white border-t shadow-lg flex justify-around items-center py-2 md:hidden z-[9999]">                <NavLink
            ...
            <div className="fixed bottom-12 left-0 w-full bg-orange-200/20 backdrop-blur-sm border-t shadow-lg flex justify-around items-center py-3 pb-6 md:hidden z-[9999]">
